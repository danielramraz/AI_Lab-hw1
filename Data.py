...
class Data:
    def __init__(self):
        ...
        niche_algorithm = 0  # int(input("Enter the niche algorithm:\n Share Fitness = 0 \nClustering = 1 \nCrowding = 2 \n"))
        viability_fuc = 0  # int(input("Enter the niche algorithm:\n Constraint_1 = 0 \Constraint_2 = 1 \n"))
        ...
        self.viability_fuc = viability_fuc
